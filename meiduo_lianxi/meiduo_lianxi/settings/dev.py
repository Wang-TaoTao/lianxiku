"""
Django settings for meiduo_lianxi project.
...
SECRET_KEY = '#sx1-vnc&_30*+t)8c24+!r$)(+vm21_h-#d-p3d1-q@8+ldig'
...
ROOT_URLCONF = 'meiduo_lianxi.urls'
...
WSGI_APPLICATION = 'meiduo_lianxi.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PORT': 3306, # 数据库端口
        'USER': 'lianxiuser', # 数据库用户名
        'PASSWORD': 'lianxiuser', # 数据库用户密码
        'NAME': 'lianxi_meiduo' # 数据库名字
    },
}
